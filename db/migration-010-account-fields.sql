...
ALTER TABLE stock_items
  ...
  ADD COLUMN IF NOT EXISTS backup_codes      TEXT,  -- 10 Google backup codes (comma-separated)
  ...
  ADD COLUMN IF NOT EXISTS recovery_password TEXT;  -- password of the reserve/recovery mailbox
