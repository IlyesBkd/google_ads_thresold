...
const NAV_ITEMS: { page: Page; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M15 5l-6-3L3 5v2l6 3 6-3V5z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinejoin="round"
        />
        <path d="M3 7v4l6 3 6-3V7" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M3 5h12v10a1 1 0 01-1 1H4a1 1 0 01-1-1V5z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <path d="M2 3a1 1 0 011-1h12a1 1 0 011 1v2H2V3z" stroke="currentColor" strokeWidth="1.5" />
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M2 4l2-2h10l2 2v12a1 1 0 01-1 1H3a1 1 0 01-1-1V4z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
