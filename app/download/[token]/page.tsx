    ...
    >
      <div style={{ maxWidth: '520px', width: '100%' }}>
        ...
        >
          ...
          >
            <i
              style={{ width: '4px', height: '8px', borderRadius: '2px', background: '#4285F4' }}
            ></i>
            <i
              style={{ width: '4px', height: '13px', borderRadius: '2px', background: '#4285F4' }}
            ></i>
            <i
              style={{ width: '4px', height: '18px', borderRadius: '2px', background: '#FBBC04' }}
            ></i>
          </span>
        ...
        >
          ...
          <p style={{ margin: '0 0 28px', fontSize: '14.5px', lineHeight: 1.6, color: '#9A9A9A' }}>
            Click the button below to download your Google Ads account credentials as a .txt file.
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              ...
              <div style={{ fontSize: '12.5px', color: '#E8D9A8', lineHeight: 1.5 }}>
                <strong style={{ color: '#FBBC04' }}>Link expires in 24 hours.</strong> You can
                download up to 3 times. Save the file immediately.
              </div>
            </div>
          </div>
        </div>
