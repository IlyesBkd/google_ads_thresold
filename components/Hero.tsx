    ...
    <section id="top" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div
        style={{
          ...
          height: '500px',
          maxWidth: '120vw',
          background: 'radial-gradient(ellipse at center, rgba(66,133,244,0.16), transparent 65%)',
          filter: 'blur(20px)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        >
          ...
          <br />
          accounts from{' '}
          <span style={{ borderBottom: '3px solid #4285F4', paddingBottom: '3px' }}>$50.</span>
        </h1>
        ...
        >
          Ready-to-use Google Ads accounts with the billing threshold already unlocked. Run ads now,
          pay later. Bonus: all accounts are eligible for Google's €400 free credit promo. Delivered
          instantly. Crypto accepted.
        </p>
