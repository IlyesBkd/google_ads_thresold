...
export default function TelegramWidget() {
  const [username, setUsername] = useState('@googleads_now');
    ...
    <a
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          '0 6px 20px rgba(0, 136, 204, 0.5), 0 3px 10px rgba(0, 0, 0, 0.3)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = 'translateY(0) scale(1)';
        e.currentTarget.style.boxShadow =
          '0 4px 16px rgba(0, 136, 204, 0.4), 0 2px 8px rgba(0, 0, 0, 0.2)';
      }}
