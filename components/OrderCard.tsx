...
export default function OrderCard({ order }: { order: Order }) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div style={{ fontSize: '11px', color: '#6A6A6A', marginBottom: '4px' }}>Quantity</div>
        ...
        <div>
          <div style={{ fontSize: '11px', color: '#6A6A6A', marginBottom: '4px' }}>Total Paid</div>
          <div style={{ fontSize: '14px', color: '#F5F5F5', fontWeight: 600 }}>
        ...
        <div>
          <div style={{ fontSize: '11px', color: '#6A6A6A', marginBottom: '4px' }}>Order Date</div>
          <div style={{ fontSize: '13px', color: '#C8C8C8' }}>{formatDate(order.createdAt)}</div>
        </div>
